    ...
    <div style={{flex:1, display:'flex', overflow:'hidden'}}>
      ...
      <main className="km-scroll" style={{flex:1, overflow:'auto', padding:'22px 32px 36px'}}>
        ...
        <div style={{columnCount:3, columnGap:12, marginBottom:24}}>
          <V4Crystal ctype="PRINCIPLE" title="A crystal sits on three kinds of material" body="Field notes (mine), guidebook (others'), playbook (how-to)." srcs={['note','doc','chat']} age="today" />
        ...
        <div style={{padding:'22px 34px 36px', display:'flex', flexDirection:'column', gap:24}}>
          ...
          <section>
            ...
            <div style={{columnCount:3, columnGap:12}}>
              ...
              <V4Crystal ctype="REMINDER" title="Field notes ≠ runbook. Notes are thinking; playbook is how-to." srcs={['note']} age="3d" />
            </div>
          </section>
          ...
          <section>
            ...
            <div style={{display:'flex', borderRadius:8, overflow:'hidden', border:'1px solid var(--v-line)'}}>
              {[
                ...
                {n:'03', l:'SHAPE', c:'var(--v-ember-dk)', v:3, d:'playbooks & guidebooks', active:true},
          ...
          <section>
            ...
            <div style={{display:'grid', gridTemplateColumns:'repeat(3, 1fr)', gap:12}}>
              {[
                ...
                { icon:Icons.runbook, accent:'var(--v-ember-dk)', label:'PLAYBOOKS', sub:'how-to', desc:'Reproducible steps + where artefacts live.', n:'2 playbooks' },
              ].map((d,i)=>(
    ...
    <div style={{flex:1, display:'grid', gridTemplateColumns:'1.3fr 1fr', overflow:'hidden'}}>
      ...
      <div className="km-scroll" style={{overflow:'auto', padding:'26px 28px', background:'var(--v-sunk)', borderLeft:'1px solid var(--v-line)'}}>
        ...
        {[
          ...
          { icon:Icons.runbook, accent:'var(--v-ember-dk)', label:'PLAYBOOK · how-to', items:[
            {kind:'doc', t:'Capture-friction playbook', m:'rev 7', strong:true},
          ]},
        ].map((g,i)=>(
...
Object.assign(window, { V4Dashboard, V4ThemeLanding, V4CrystalDetail });
