      ...
      <div style={{ maxWidth: 880, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <button className="panel" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 9,
            ...
            onClick={() => cmpToast({ text: 'Setting a bearing is a slow, deliberate mood — not a quick capture.', kind: 'crystal' })}>
...
Object.assign(window, { CompassBand, TideCompass, TideOrientation });
