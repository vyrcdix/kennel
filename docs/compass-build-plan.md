...
| P4 | Compass lens + orientation page | `TideCompass` (new **Compass** Mood/route) + `TideOrientation` (forward crystal · horizon · wake · what's-built roll-up · today's promise · "still about?"); creation flow wired | none |
